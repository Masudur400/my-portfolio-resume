...
export const AllProjects = [
        ...
        },
        {
            ...
            description:['Users: search, apply, review scholarships','Admin: manage scholarships & applications','Track application status in real-time']
        },
        {
            id: 5,
            img: project3,
        ...
        },
        {
            ...
            description:['Users can browse, search, and order products','Admin dashboard to manage products, orders, and users','Responsive UI with pagination and filtering']
        },
    ]
