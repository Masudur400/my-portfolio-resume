        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:w-[600px] mx-auto"> 
            {gridItems.map((item) => (
                <div
                    ...
                    className={`w-fit mx-auto md:px-8 md:py-4 px-6 py-2 border-2 border-purple-700 border-opacity-70 hover:shadow-purple-400 hover:shadow-md rounded text-center cursor-move ${
