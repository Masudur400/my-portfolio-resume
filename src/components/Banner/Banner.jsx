        ...
        <div className="avg w-full max-sm:h-[680px]">
            <div className='bg-black bg-opacity-80 h-full py-10'>
                <div className='md:flex gap-5 items-center '>
                    <img src={img1} alt="" className='h-72 w-72 border-2 rounded-full lg:ml-20 md:ml-10 mx-1 md:mt-8' />
                    <div className='text-white opacity-90 max-sm:ml-4 lg:w-2/5 md:w-2/4 mt-3'>
                        ...
                        <p>I am a highly skilled and motivated front-end developer with a passion for creating innovative and user-friendly websites and web applications.I am strongly skilled in javascript.I am also skilled in React. I love to do things with React.I always try to explore more about the technologies that i like.</p>
                            ...
                            <a href="https://drive.google.com/file/d/1CNBAE75-_VPd1MhHeH5xTgjoX4lZRyT4/view?usp=sharing" target='blank' className='text-white w-fit bg-indigo-500 px-4 py-2 rounded-md mt-3 flex gap-1 justify-center items-center'><LuDownload></LuDownload> Download Resume</a>
