...
const Banner = () => {
    return (
        <div className="avg w-full max-sm:h-[680px]">
            <div className='bg-black bg-opacity-80 h-full lg:py-10'>
                <div className='md:flex gap-9 lg:gap-24 items-center'>
                    <img src={img2} alt="" data-aos="zoom-in" className='h-72 w-72 lg:h-96 lg:w-96 border-2 rounded-full lg:ml-20 md:ml-10 md:mx-1 mx-auto md:mt-8 hover:shadow-lg hover:shadow-purple-400' />
                    <div className='text-white text-opacity-80 opacity-90 max-sm:ml-4 lg:w-3/6 md:w-2/4 mt-3 flex flex-col gap-5' data-aos="zoom-in">
                        ...
                        <p>Aspiring web developer with a solid foundation in front-end and back-end technologies, eager to contribute skills in building
                            ...
                            new technologies.</p> 
                        <a href="https://drive.google.com/file/d/15zTeYNOQiSP3MSIbLk51s4SQKMvxXUWk/view?usp=sharing" target='blank' className='text-white w-fit bg-indigo-500 px-4 py-2 rounded-md mt-3 flex gap-1 justify-center items-center max-sm:text-sm'><LuDownload></LuDownload> Download Resume</a> 
                    </div>
                </div> 
            </div>
        </div>
