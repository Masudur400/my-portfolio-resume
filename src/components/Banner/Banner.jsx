        ...
        <div className="avg w-full max-sm:h-[680px]">
            <div className='bg-black bg-opacity-80 h-full py-10'>
                <div className='md:flex gap-9 items-center '>
                    <img src={img2} alt="" data-aos="zoom-in" className='h-72 w-72 border-2 rounded-full lg:ml-20 md:ml-10 md:mx-1 mx-auto md:mt-8 hover:shadow-lg hover:shadow-purple-400' />
